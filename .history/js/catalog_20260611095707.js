...
function agregarAlCarrito(id) {
    ...
    if (!usuarioActivo) {
        alert("⚠️ Para poder añadir productos al carrito y realizar compras, debes iniciar sesión o registrarte.");
    ...
    if (usuarioActivo.role === 'admin') {
        alert("👨‍💻 Eres Administrador. Para gestionar, añadir o eliminar este producto, por favor ve al 'Panel Admin' en el menú superior.");
        navigate('admin'); 
        return;
    }
